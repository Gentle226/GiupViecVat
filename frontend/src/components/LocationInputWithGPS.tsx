      ...
      <div className="relative">
        <input
          ...
          className={`w-full pl-10 ${
            showGPSButton ? "pr-16" : "pr-4"
          } py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${className}`}
        />
