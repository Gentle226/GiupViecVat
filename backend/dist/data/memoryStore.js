...
const findUserByResetToken = async (token) => {
    return users.find((user) => user.resetPasswordToken === token &&
        ...
        user.resetPasswordExpires > new Date()) || null;
};
...
exports.memoryStore = {
    ...
    findUserByResetToken: exports.findUserByResetToken,
